...
* [服务器管理指南](04_Server Administration Guide.md)
  ...
  * [ 9. 角色](04_Server Administration Guide.md#Roles)
    * [ 9.1. 领域角色](04_Server Administration Guide.md#Realm_Roles)
    * [ 9.2. 客户端 角色](04_Server Administration Guide.md#Client_Roles)
    * [ 9.3. 复合 角色](04_Server Administration Guide.md#Composite_Roles)
    * [ 9.4. 用户角色映射](04_Server Administration Guide.md#User_Role_Mappings)
    * [ 9.5. 角色范围映射](04_Server Administration Guide.md#Role_Scope_Mappings)
  * [ 10. 组](04_Server Administration Guide.md#Groups)
    * [ 10.1. 群组与角色](04_Server Administration Guide.md#Groups_vs__Roles)
    * [ 10.2. 默认组](04_Server Administration Guide.md#Default_Groups)
  * [ 11. 管理控制台访问控制和权限](04_Server Administration Guide.md#Admin_Console_Access_Control_and_Permissions)
    * [ 11.1. Master Realm访问控制](04_Server Administration Guide.md#Master_Realm_Access_Control)
    * [ 11.2. 专用领域管理控制台](04_Server Administration Guide.md#Dedicated_Realm_Admin_Consoles)
    * [ 11.3. 细粒度管理员权限](04_Server Administration Guide.md#Fine_Grain_Admin_Permissions)
    * [ 11.4. 领域密钥](04_Server Administration Guide.md#Realm_Keys)
  * [ 12. 身份代理](04_Server Administration Guide.md#Identity_Brokering)
    * [ 12.1. 经纪概述](04_Server Administration Guide.md#Brokering_Overview)
    * [ 12.2. 默认身份提供者](04_Server Administration Guide.md#Default_Identity_Provider)
    * [ 12.3. 一般配置](04_Server Administration Guide.md#General_Configuration)
    * [ 12.4. 社交身份提供者](04_Server Administration Guide.md#Social_Identity_Providers)
    * [ 12.5. OpenID Connect v1.0 身份提供商](04_Server Administration Guide.md#OpenID_Connect_v1_0_Identity_Providers)
    * [ 12.6. SAML v2.0 身份提供商](04_Server Administration Guide.md#SAML_v2_0_Identity_Providers)
    * [ 12.7. 客户建议身份提供商](04_Server Administration Guide.md#Client_suggested_Identity_Provider)
    * [ 12.8. 映射声明和断言](04_Server Administration Guide.md#Mapping_Claims_and_Assertions)
    * [ 12.9. 可用的用户会话数据](04_Server Administration Guide.md#Available_User_Session_Data)
    * [ 12.10. 首次登录流程](04_Server Administration Guide.md#First_Login_Flow)
    * [ 12.11. 检索外部IDP令牌](04_Server Administration Guide.md#Retrieving_External_IDP_Tokens)
    * [ 12.12. 身份代理注销](04_Server Administration Guide.md#Identity_broker_logout)
  * [ 13. 用户会话管理](04_Server Administration Guide.md#User_Session_Management)
    * [ 13.1. 管理会话](04_Server Administration Guide.md#Administering_Sessions)
    * [ 13.2. 撤销策略](04_Server Administration Guide.md#Revocation_Policies)
    * [ 13.3. 会话和令牌超时](04_Server Administration Guide.md#Session_and_Token_Timeouts)
    * [ 13.4. 离线访问](04_Server Administration Guide.md#Offline_Access)
  * [ 14. 用户存储联合](04_Server Administration Guide.md#User_Storage_Federation)
    * [ 14.1. 添加提供商](04_Server Administration Guide.md#Adding_a_Provider)
    * [ 14.2. 处理提供商失败](04_Server Administration Guide.md#Dealing_with_Provider_Failures)
    * [ 14.3. LDAP和Active Directory](04_Server Administration Guide.md#LDAP_and_Active_Directory)
    * [ 14.4. SSSD和FreeIPA身份管理集成](04_Server Administration Guide.md#SSSD_and_FreeIPA_Identity_Management_Integration)
    * [ 14.5. 配置联合SSSD存储](04_Server Administration Guide.md#Configuring_a_Federated_SSSD_Store)
    * [ 14.6. 定制供应商](04_Server Administration Guide.md#Custom_Providers)
  * [ 15. 审计和事件](04_Server Administration Guide.md#Auditing_and_Events)
    * [ 15.1. 登录活动](04_Server Administration Guide.md#Login_Events)
    * [ 15.2. 管理事件](04_Server Administration Guide.md#Admin_Events)
  * [ 16. 导出和导入](04_Server Administration Guide.md#Export_and_Import)
    * [ 16.1. 管理控制台导出/导入](04_Server Administration Guide.md#Admin_console_export_import)
  * [ 17. 用户帐户服务](04_Server Administration Guide.md#User_Account_Service)
    * [ 17.1. 主题化](04_Server Administration Guide.md#Themeable)
  * [ 18. 威胁模型缓解](04_Server Administration Guide.md#Threat_Model_Mitigation)
    * [ 18.1. 主机名](04_Server Administration Guide.md#Host)
    * [ 18.2. 管理员端点和控制台](04_Server Administration Guide.md#Admin_Endpoints_and_Console)
    * [ 18.3. 密码猜测：暴力攻击](04_Server Administration Guide.md#Password_guess:_brute_force_attacks)
    * [ 18.4. 点击劫持](04_Server Administration Guide.md#Clickjacking)
    * [ 18.5. SSL/HTTPS要求](04_Server Administration Guide.md#SSL_HTTPS_Requirement)
    * [ 18.6. CSRF 攻击](04_Server Administration Guide.md#CSRF_Attacks)
    * [ 18.7. 非特定的重定向URI](04_Server Administration Guide.md#Unspecific_Redirect_URIs)
    * [ 18.8. 受损的访问和刷新令牌](04_Server Administration Guide.md#Compromised_Access_and_Refresh_Tokens)
    * [ 18.9. 受损的授权码](04_Server Administration Guide.md#Compromised_Authorization_Code)
    * [ 18.10. 打开重定向器](04_Server Administration Guide.md#Open_redirectors)
    * [ 18.11. 密码数据库受损](04_Server Administration Guide.md#Password_database_compromised)
    * [ 18.12. 限制范围](04_Server Administration Guide.md#Limiting_Scope)
    * [ 18.13. 限制令牌受众](04_Server Administration Guide.md#Limit_Token_Audience)
    * [ 18.14. SQL注入攻击](04_Server Administration Guide.md#SQL_Injection_Attacks)
  * [ 19. 管理员 命令行](04_Server Administration Guide.md#The_Admin_CLI)
    * [ 19.1. 安装Admin CLI](04_Server Administration Guide.md#Installing_the_Admin_CLI)
    * [ 19.2. 使用Admin CLI](04_Server Administration Guide.md#Using_the_Admin_CLI)
    * [ 19.3. 认证](04_Server Administration Guide.md#Authenticating)
    * [ 19.4. 使用其他配置](04_Server Administration Guide.md#Working_with_alternative_configurations)
