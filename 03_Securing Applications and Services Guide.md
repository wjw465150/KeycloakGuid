...
<a name="18_____1_3_2__SAML_2_0"></a>
#### 1.3.2. SAML 2.0
...
<a name="39______Camel_RestDSL"></a>
##### Camel RestDSL
...
<a name="40______在单独的Jetty引擎上保护Apache_CXF端点"></a>
...
<a name="57______在单独的Undertow引擎上保护Apache_CXF端点"></a>
...
<a name="62______保护Hawtio管理控制台"></a>
##### 保护Hawtio管理控制台
...
<a name="63_____2_1_6__Spring_Boot_适配器"></a>
...
<a name="65______必需的Spring_Boot_Adapter配置"></a>
...
<a name="66_____2_1_7__Tomcat_6__7_and_8_适配器"></a>
...
<a name="72_____2_1_9__Spring_Security_适配器"></a>
...
<a name="80______Spring_Boot集成"></a>
##### Spring Boot集成
...
<a name="81_______使用Spring_Boot配置"></a>
###### 使用Spring Boot配置
...
<a name="83_____2_1_10__Java_Servlet_Filter_适配器"></a>
...
<a name="87_____2_1_11__JAAS_插件"></a>
#### 2.1.11. JAAS 插件
...
<a name="88_____2_1_12__CLI___Desktop_应用"></a>
...
<a name="98_____2_1_17__客户端身份验证"></a>
#### 2.1.17. 客户端身份验证
...
<a name="99______客户端ID和客户端Secret"></a>
##### 客户端ID和客户端Secret
...
<a name="100______使用签名JWT的客户端身份验证"></a>
##### 使用签名JWT的客户端身份验证
...
<a name="101______使用客户端密钥使用签名JWT进行客户端身份验证"></a>
...
<a name="102______添加自己的客户端身份验证方法"></a>
##### 添加自己的客户端身份验证方法
...
<a name="104_____2_1_19__应用程序集群"></a>
#### 2.1.19. 应用程序集群
...
<a name="110____2_2__JavaScript_适配器"></a>
### 2.2. JavaScript 适配器
...
<a name="111_____2_2_1__会话状态iframe"></a>
#### 2.2.1. 会话状态iframe
...
<a name="112_____2_2_2__隐式和混合流"></a>
#### 2.2.2. 隐式和混合流
...
<a name="113_____2_2_3__与Cordova的混合应用程序"></a>
...
<a name="114_____2_2_4__早期的浏览器"></a>
#### 2.2.4. 早期的浏览器
...
<a name="115_____2_2_5__JavaScript适配器参考"></a>
#### 2.2.5. JavaScript适配器参考
<a name="116______构造函数"></a>
##### 构造函数
```javascript
new Keycloak();
...
<a name="118______方法"></a>
##### 方法
<a name="119_______init（选项）"></a>
###### init（选项）
调用初始化适配器。
...
<a name="123_______createLogoutUrl_选项_"></a>
###### createLogoutUrl(选项)
返回用于注销用户的URL。
...
<a name="124_______register_选项_"></a>
###### register(选项)
重定向到注册表单。 使用选项 action = 'register'登录的快捷方式

选项与登录方法相同，但'action'设置为'register'

<a name="125_______createRegisterUrl_选项_"></a>
###### createRegisterUrl(选项)
返回注册页面的url。 带有选项action = 'register'的createLoginUrl的快捷方式

选项与createLoginUrl方法相同，但'action'设置为'register'

<a name="126_______accountManagement__"></a>
###### accountManagement()
重定向到帐户管理控制台。

<a name="127_______createAccountUrl__"></a>
###### createAccountUrl()
返回帐户管理控制台的URL。

<a name="128_______hasRealmRole_role_"></a>
###### hasRealmRole(role)
如果令牌具有给定的域角色，则返回true。

<a name="129_______hasResourceRole_role__resource_"></a>
###### hasResourceRole(role, resource)
如果令牌具有资源的给定角色，则返回true（如果未使用指定的clientId，则资源是可选的）。

<a name="130_______loadUserProfile__"></a>
###### loadUserProfile()
加载用户个人资料。
...
<a name="131_______isTokenExpired_minValidity_"></a>
###### isTokenExpired(minValidity)
如果令牌在到期之前的剩余时间小于minValidity秒，则返回true（minValidity是可选的，如果未指定0则使用）。

<a name="132_______updateToken_minValidity_"></a>
...
<a name="135____2_3__Node_js_适配器"></a>
### 2.3. Node.js 适配器
...
<a name="139_____2_3_4__检查身份验证"></a>
#### 2.3.4. 检查身份验证
...
<a name="141_____2_3_6__其他URLs"></a>
#### 2.3.6. 其他URLs
- 显式用户触发的注销
...
<a name="142____2_4__Keycloak_看门人"></a>
### 2.4. Keycloak 看门人
...
<a name="145_____2_4_3__示例用法和配置"></a>
#### 2.4.3. 示例用法和配置
...
<a name="146_____2_4_4__OpenID提供商通信"></a>
#### 2.4.4. OpenID提供商通信
...
<a name="147_____2_4_5__HTTP路由"></a>
#### 2.4.5. HTTP路由
...
<a name="150_____2_4_8__转发已签名的HTTPS连接"></a>
#### 2.4.8. 转发已签名的HTTPS连接
...
<a name="151_____2_4_9__HTTPS重定向"></a>
#### 2.4.9. HTTPS重定向
...
<a name="152_____2_4_10__我们加密配置"></a>
#### 2.4.10. 我们加密配置
...
<a name="153_____2_4_11__访问令牌加密"></a>
#### 2.4.11. 访问令牌加密
...
<a name="155_____2_4_13__自定义声明标头"></a>
#### 2.4.13. 自定义声明标头
...
<a name="156_____2_4_14__自定义标题"></a>
#### 2.4.14. 自定义标题
...
<a name="160_____2_4_18__自定义页面"></a>
#### 2.4.18. 自定义页面
...
<a name="161_____2_4_19__白名单_URL_s"></a>
#### 2.4.19. 白名单 URL's
...
<a name="166_____2_4_24__跨域资源共享__CORS_"></a>
#### 2.4.24. 跨域资源共享 (CORS)
...
<a name="167_____2_4_25__上游URL"></a>
#### 2.4.25. 上游URL
...
<a name="171_____2_4_29__已知的问题"></a>
#### 2.4.29. 已知的问题
...
<a name="172____2_5__其他OpenID连接库"></a>
### 2.5. 其他OpenID连接库
...
<a name="181_____2_5_2__验证访问令牌"></a>
#### 2.5.2. 验证访问令牌
...
<a name="182_____2_5_3__流"></a>
#### 2.5.3. 流
<a name="183______授权码"></a>
##### 授权码
...
<a name="188_____2_5_4__重定向URI"></a>
#### 2.5.4. 重定向URI
...
<a name="189___3__SAML"></a>
## 3. SAML

本节介绍如何使用Keycloak客户端适配器或通用SAML提供程序库使用SAML保护应用程序和服务。

<a name="190____3_1__Java_适配器"></a>
### 3.1. Java 适配器

Keycloak为Java应用程序提供了一系列不同的适配器。 选择正确的适配器取决于目标平台。

<a name="191_____3_1_1__通用适配器配置"></a>
#### 3.1.1. 通用适配器配置
...
<a name="193______服务提供商密钥和关键元素"></a>
##### 服务提供商密钥和关键元素
...
<a name="196______SP_PrincipalNameMapping_元素"></a>
...
<a name="197______RoleIdentifiers_元素"></a>
##### RoleIdentifiers 元素
...
<a name="199______IDP_SingleSignOnService_子元素"></a>
...
<a name="200______IDP_SingleLogoutService_子元素"></a>
...
<a name="201______IDP_Keys_子元素"></a>
##### IDP Keys 子元素
...
<a name="202______IDP_HttpClient_子元素"></a>
##### IDP HttpClient 子元素
...
<a name="203_____3_1_2__JBoss_EAP_WildFly_适配器"></a>
...
<a name="205______JBoss_SSO"></a>
##### JBoss SSO
WildFly内置支持部署到同一WildFly实例的Web应用程序的单点登录。 使用Keycloak时不应启用此功能。

<a name="206_____3_1_3__从RPM安装JBoss_EAP适配器"></a>
...
<a name="208______通过Keycloak_SAML子系统保护WAR"></a>
...
<a name="209_____3_1_4__Tomcat_SAML_适配器"></a>
...
<a name="212_____3_1_5__Jetty_SAML_适配器"></a>
...
<a name="213______Jetty_9_适配器安装"></a>
##### Jetty 9 适配器安装
...
<a name="214______Jetty_9_每个_WAR_配置"></a>
##### Jetty 9 每个 WAR 配置
...
<a name="215_____3_1_6__Java_Servlet_过滤器适配器"></a>
...
<a name="219______在Cross_DC场景中注销"></a>
##### 在Cross DC场景中注销
...
<a name="220_____3_1_9__获取断言属性"></a>
#### 3.1.9. 获取断言属性
...
<a name="224_____3_1_13__从旧版本迁移"></a>
#### 3.1.13. 从旧版本迁移

<a name="225______迁移到1_9_0"></a>
##### 迁移到1.9.0
<a name="226_______SAML_SP_客户端_适配器更改"></a>
###### SAML SP 客户端 适配器更改
...
<a name="227____3_2__mod_auth_mellon_Apache_HTTPD_模块"></a>
...
<a name="228_____3_2_1__使用Keycloak配置mod_auth_mellon"></a>
...
<a name="230______为Apache_SAML创建配置目录"></a>
##### 为Apache SAML创建配置目录
...
<a name="231______配置Mellon服务提供商"></a>
##### 配置Mellon服务提供商
...
<a name="233______将Mellon服务提供商添加到Keycloak身份提供商"></a>
...
<a name="236_______编辑Mellon_SP客户端"></a>
###### 编辑Mellon SP客户端
我们建议设置几个客户端配置参数：
...
<a name="237_______检索身份提供程序元数据"></a>
###### 检索身份提供程序元数据
...
<a name="239____4_1__Docker注册表配置文件安装"></a>
### 4.1. Docker注册表配置文件安装
...
<a name="240____4_2__Docker注册表环境变量覆盖安装"></a>
...
<a name="241____4_3__Docker撰写YAML文件"></a>
### 4.3. Docker撰写YAML文件
...
<a name="245_____5_1_2__初始访问令牌"></a>
#### 5.1.2. 初始访问令牌
...
<a name="246_____5_1_3__注册访问令牌"></a>
#### 5.1.3. 注册访问令牌
...
<a name="247____5_2__Keycloak表示"></a>
### 5.2. Keycloak表示
...
<a name="248____5_3__Keycloak适配器配置"></a>
### 5.3. Keycloak适配器配置
...
<a name="249____5_4__OpenID连接动态客户端注册"></a>
### 5.4. OpenID连接动态客户端注册
...
<a name="250____5_5__SAML实体描述符"></a>
### 5.5. SAML实体描述符
...
<a name="251____5_6__使用CURL的示例"></a>
### 5.6. 使用CURL的示例
...
<a name="252____5_7__使用Java客户端注册API的示例"></a>
...
<a name="255____6_1__配置新常规用户以使用客户端注册CLI"></a>
...
<a name="256____6_2__配置客户端以与客户端注册CLI一起使用"></a>
...
<a name="257____6_3__安装客户端注册CLI"></a>
### 6.3. 安装客户端注册CLI
...
<a name="258____6_4__使用客户端注册CLI"></a>
### 6.4. 使用客户端注册CLI
...
<a name="260_____6_4_2__使用其他配置"></a>
#### 6.4.2. 使用其他配置
...
<a name="261_____6_4_3__初始访问和注册访问令牌"></a>
#### 6.4.3. 初始访问和注册访问令牌
...
<a name="262_____6_4_4__创建客户端配置"></a>
#### 6.4.4. 创建客户端配置
...
<a name="263_____6_4_5__检索客户端配置"></a>
#### 6.4.5. 检索客户端配置
...
<a name="264_____6_4_6__修改客户端配置"></a>
#### 6.4.6. 修改客户端配置
有两种更新客户端配置的方法。
...
<a name="265_____6_4_7__删除客户端配置"></a>
#### 6.4.7. 删除客户端配置
使用以下示例删除客户端。
...
<a name="266_____6_4_8__刷新无效的注册访问令牌"></a>
#### 6.4.8. 刷新无效的注册访问令牌
...
<a name="269____7_1__内部令牌到内部令牌交换"></a>
### 7.1. 内部令牌到内部令牌交换
...
<a name="270_____7_1_1__授予Exchange权限"></a>
#### 7.1.1. 授予Exchange权限
...
<a name="272____7_2__外部令牌交换的内部令牌"></a>
### 7.2. 外部令牌交换的内部令牌
...
<a name="273_____7_2_1__授予Exchange权限"></a>
#### 7.2.1. 授予Exchange权限
...
<a name="275____7_3__外部令牌到内部令牌交换"></a>
### 7.3. 外部令牌到内部令牌交换
...
<a name="276_____7_3_1__授予Exchange权限"></a>
#### 7.3.1. 授予Exchange权限
...
<a name="282_____7_5_1__授予Exchange权限"></a>
#### 7.5.1. 授予Exchange权限
...
<a name="284____7_6__使用服务帐户展开权限模型"></a>
### 7.6. 使用服务帐户展开权限模型
